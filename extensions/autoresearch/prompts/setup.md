...
## Your job
1. Read `benchmark.json`, `README.md`, `TASK.md`, and `AGENTS.md`/`CLAUDE.md` if present.
2. Identify the **subject area** and build a contextual knowledge base at `{{stateDir}}/knowledge-base.md`: objective, levers (what the editable paths control), constraints, scoring model, and any competitor intel from git history or notes.
