...
Do not optimize the candidate, edit candidate code, or run an open-ended research loop. Complete only the assigned initialization task and return the requested structured result.
