    ...
    const cases: Array<{
      ...
      },
      {
        ...
        expected: [
          ...
          '"status": "blocked-external"',
          "choose the safest documented reduced local signal",
        ],
      },
      {
        task: makeTask(tmpDir, {
          ...
          input: {
            ...
            previousVerifyCommand: "./verify.sh",
            previousBenchCommand: "./benchmark.sh",
            decisionRequest: "Choose between the full and local-iterate modes.",
            evidencePaths: [
              "/tmp/project/benchmark.json",
              "/tmp/project/.autoresearch/logs/benchmark.log",
            ],
          },
        }),
        expected: [
          ...
          "Choose between the full and local-iterate modes.",
        ...
        task: makeTask(tmpDir, {
          ...
          input: {
            ...
            localEvaluation: {
              ...
              limitations: ["Official hardware is not exercised."],
